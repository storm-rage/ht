  ...
  <div class="zj-p-t-20 zj-p-b-20">
    ...
    <el-form ref="form" class="w500px zj_20px-auto-0" :model="form" label-width="140px">
      ...
      <el-form-item label="开通产品：" prop="productTypes" class="required" :rules="[{ required: true, message: '请选择开通产品', trigger: 'change' }]">
        <el-checkbox-group v-model="form.productTypes">
      ...
      <el-form-item :label="`${index===0?'其他资金方企业名称：':''}`" v-for="(index) in form.fundingEnts" :key="index">
      ...
      <el-form-item>
        <zj-button  status="primary" @click="submitForm" :api="zjBtn.addPubProject">保存</zj-button>
