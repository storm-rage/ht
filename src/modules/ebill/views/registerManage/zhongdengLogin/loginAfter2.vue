            ...
            <zj-content-block>
                <el-form label-width="200px" class="zj-m-t-20">
                    <zj-content-block>
                        ...
                        <el-row>
                            <el-form-item label="填表人名称：">{{ row.pawneeInfo.pawneeName }}</el-form-item>
                    ...
                    <zj-content-block>
                        ...
                        <zj-table ref="searchTable" class="zj-search-table" :dataList="row.debtorInfoList"
                            ...
                            <zj-table-column field="industryRegistrationCode" title="工商注册号/统一社会信用代码/事业单位法人证书号/机构注册登记证号" />
                    ...
                    <zj-content-block>
                        ...
                        <zj-table ref="searchTable" class="zj-search-table" :dataList="row.pawneeInfo"
                            :pager="false">
                    ...
                    <zj-content-block>
                        ...
                        <h1>合同信息</h1>
                        <zj-table ref="searchTable" class="zj-search-table" :dataList="row.contractInfo"
                            :pager="false">
