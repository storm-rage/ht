  ...
  <zj-content-container>
    ...
    <zj-content-block v-if="workflow === 'pzxx' && row.financingProductType !== '0'">
      <zj-content-block>
        ...
        <zj-content>
          <zj-table ref="billInfoTable" class="zj-search-table" :api="zjControl.getFinancingBillInfos"
            :params="{ id: row.id, serialNo: row.serialNo, }" @after-load="handleDataChange"
