<template>
  <el-dialog title="贸易背景" :visible.sync="dialogShow" width="1300px" :close-on-click-modal="true" left>
    <zj-content-container>
      <!--    贸易合同    -->
      <zj-content-block>
        <zj-header title="贸易合同信息" />
        <zj-button type="primary" icon="el-icon-circle-plus-outline" @click="addContract">新增</zj-button>
        <zj-table ref="contractTable" :dataList="form.contractList" keep-source :edit-config="{trigger: 'manual', mode: 'row', icon:'-', autoClear: false,showStatus: true}" :pager="false">
      ...
      <zj-content-block>
        ...
        <zj-table ref="invoiceTable" :dataList="form.invoiceList" keep-source :edit-config="{trigger: 'manual', mode: 'row', icon:'-', autoClear: false,showStatus: true}" :pager="false">
      ...
      <zj-content-block>
        ...
        <zj-table ref="otherAttachTable" :dataList="form.otherAttachList" keep-source :edit-config="{trigger: 'manual', mode: 'row', icon:'-', autoClear: false,showStatus: true}" :pager="false">
