    ...
    <zj-content-container>
      ...
      <div class="zj-search-condition zj-m-b-20" style="border-bottom: none;">
        <zj-list-layout>
            ...
            <el-form ref="searchForm" :model="searchForm">
              <el-form-item label="融资申请日期：">
                <zj-date-range-picker :startDate.sync="searchForm.applyDateStart"
                  :endDate.sync="searchForm.applyDateEnd"></zj-date-range-picker>
              </el-form-item>
              ...
              <el-form-item label="融资业务状态：">
                <el-select v-model="searchForm.workflowState">
                  ...
                  <el-option v-for="item in dictionary.financingStateList" :label="item.desc" :value="item.code"
                    :key="item.code" />
                </el-select>
              </el-form-item>
          ...
          <zj-table ref="searchTable" :api="zjControl.queryFinancingTranPage" :params="searchForm">
