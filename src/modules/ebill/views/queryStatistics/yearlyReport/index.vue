    ...
    <zj-content-container>
      ...
      <zj-list-layout>
        ...
        <zj-table ref="searchTable" :dataList="list">
          ...
          <zj-table-column field="field1" title="供应商名称" width="80" />
          <zj-table-column field="field3" title="核心企业名称" width="90" />
          <vxe-table-colgroup title="融资金额">
            ...
            <zj-table-column
              ...
              width="60"
            />
            <zj-table-column field="field6" title="同比" width="60" />
          </vxe-table-colgroup>
          <vxe-table-colgroup title="签收凭证金额">
            ...
            <zj-table-column
              ...
              width="60"
            />
            <zj-table-column field="field7" title="同比" width="60" />
          </vxe-table-colgroup>
