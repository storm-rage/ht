        ...
        <zj-list-layout>
          ...
          <template slot="searchForm">
            <el-form ref="searchForm" :model="searchForm">
              ...
              <el-form-item label="融资申请日期：">
                <zj-date-range-picker :startDate.sync="searchForm.applyDateStart"
              ...
              <el-form-item label="融资申请状态：">
                <el-select v-model="searchForm.workflowState" placeholder="请选择" filterable
                  :popper-append-to-body="false">
                  <el-option label="全部" value=""></el-option>
                  <el-option v-for="item in dictionary.financingStateList" :key="item.code" :label="item.desc"
                    :value="item.code" />
                </el-select>
              </el-form-item>
            </el-form>
          ...
          <zj-table ref="searchTable" :params="searchForm" :api="zjControl.queryFinancingTransPage">
            <zj-table-column title="融资流水号">
              <template v-slot="{ row }">
                <span class="table-elbill-code" @click="toDetail(row)">{{ row.serialNo
                }}</span>
              </template>
            </zj-table-column>
            ...
            <zj-table-column field="createDatetime" title="融资申请时间" :formatter="date" />
            <zj-table-column field="workflowState" title="融资申请状态"
