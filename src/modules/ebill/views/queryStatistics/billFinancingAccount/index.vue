          ...
          <div class="zj-search-condition zj-m-b-20" style="border-bottom: none;">
            <zj-list-layout>
              ...
              <zj-table ref="searchTable" :params="searchForm" :api="zjControl.queryStatementSrmAccountBillPage">
                ...
                <zj-table-column field="isApplyVoucher" title="到期日" :formatter="date"/>
                ...
                <zj-table-column field="isSettle" title="还款日期" :formatter="date"/>
                <zj-table-column field="isSettle" title="计息天数" />
                <zj-table-column field="ebillCode" title="还款金额" :formatter="money"/>
                <zj-table-column field="isBusPush" title="偿还本金" :formatter="money"/>
                <zj-table-column field="isHbkPush" title="偿还利息" :formatter="money"/>
                <zj-table-column field="isHbkPush" title="未偿还本金" :formatter="money"/>
