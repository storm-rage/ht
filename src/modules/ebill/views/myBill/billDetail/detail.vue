<template>
  <zj-content-block>
    <zj-top-header>电子债权凭证详情</zj-top-header>
    <div class="ta-c mb-20">融单编号：{{ detailData.billInfo }}</div>
    <zj-content>
      <!--凭证详情-->
      <zj-collapse title="根单编号">
        <!--<div>根单编号：{{detailData.billInfo.rootCode}}</div>-->
        <table
          class="detail-table"
          border="0"
          cellspacing="0"
        ...
        >
          <tr>
            <td rowspan="3" class="right">开单企业</td>
            <td>企业名称</td>
            <td colspan="2"></td>
