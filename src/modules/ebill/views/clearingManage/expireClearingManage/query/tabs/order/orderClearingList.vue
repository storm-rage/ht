  ...
  <div ref="clearingListRef">
    <zj-list-layout>
      ...
      <zj-table ref="searchTable"
        ...
        <zj-table-column field="field6" title="确认收款日期" :formatter="date"/>
        <zj-table-column field="field7" title="确认收款金额" :formatter="money"/>
        <zj-table-column field="field7" title="实际付款金额" :formatter="money"/>
