<template>
  <zj-content-container>
    ...
    <!--  具体业务信息  -->
    <contract-re-sign-back-audit ref="bizInfoRef" :biz-id="row.bizId"></contract-re-sign-back-audit>
    <!--  操作记录  -->
...
export default {
  ...
  components: {
    ...
    OperateLog,
    AuditRemark,
    contractReSignBackAudit
  },
  data () {
    return {
      zjControl: {
        submitContractRenewalRebut: this.$api.businessManageWorkflow.submitContractRenewalRebut
      },
      rejectLoading: false,
      passLoading: false
    }
  ...
  methods: {
    toPass() {
      ...
      if (tradeRelationParamModelList.length) {
        ...
        this.zjControl.submitContractRenewalRebut({
          id: this.row.bizId,
          notes,
