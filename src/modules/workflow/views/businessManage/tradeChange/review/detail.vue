<template>
  <zj-content-container>
    ...
    <!--  具体业务信息  -->
    <business-detail :biz-id="row.bizId" :is-show-contract-info="true" :detail-api="zjControl.getDetail"></business-detail>
    <!--  操作记录  -->
...
export default {
  ...
  data () {
    return {
      zjControl: {
        getDetail: this.$api.businessManageWorkflow.getTradeRecheckDetail
      },
    }
  },
  created() {
