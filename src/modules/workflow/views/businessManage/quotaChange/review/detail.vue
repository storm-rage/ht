<template>
  <zj-content-container>
    ...
    <!--  具体业务信息  -->
    <business-detail :biz-id="row.bizId" :detail-api="zjControl.getDetail" :rowData="row" ></business-detail>
    <!--  操作记录  -->
...
export default {
  ...
  data () {
    return {
      zjControl: {
        getDetail: this.$api.businessManageWorkflow.getLimitRecheckDetail
      },
    }
  },
  created() {
