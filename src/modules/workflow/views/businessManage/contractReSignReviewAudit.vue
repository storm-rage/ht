<template>
  <zj-content-container>
    ...
    <zj-content-footer>
      ...
      <zj-button type="primary" :disabled="passLoading" :loading="rejectLoading" :api="zjBtn.recheckContractRenewal" @click="toReject">拒绝</zj-button>
...
import contractReSignReviewAudit from '@modules/ebill/views/productManage/businessManage/workflow/contractReSignReviewAudit.vue';
