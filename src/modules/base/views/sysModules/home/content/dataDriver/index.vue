<template>
  <home-content-block class="home-content-data-driver">
    <header>
      <img src="~@assets/img/home/dataDriver/font_bg.png">
    </header>
    <!-- todo:?   -->
    <hx-ent v-if="currentEnt==='1'"></hx-ent>
    <!-- 供应商   -->
    <gys-ent v-if="currentEnt==='2'"></gys-ent>
    <!--  运营  -->
    <yy-ent v-if="currentEnt==='3'"></yy-ent>
  </home-content-block>
</template>
<script>
