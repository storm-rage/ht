        ...
        >
          <div class="notice-content">
            ...
            <div class="top-content">
              <div class="top">
                <div class="title">
                  <span v-if="!item.isRead" class="not-read"></span>
                  {{ item.theme }}
                </div>
                <div class="date">
                  <span v-if="item.creator">Admin&nbsp;&nbsp;|</span
                  >&nbsp;&nbsp;{{ item.createDatetime }}
                </div>
              </div>
              <div class="detail-btn" :class="{ 'not-read': !item.isRead }">
                <el-link type="primary" @click="toViewDetail(item)"
                  >详情</el-link
                >
              </div>
            </div>
          ...
          <div
            ...
            :class="{ 'is-show': selectIds.includes(item.id) }"
          >
            {{ item.content }}
          </div>
        </div> -->
