(function(win) {
    var CLODOP = {
      strWebPageID: "7BCAAAR",
      strTaskID: "",
      strHostURI: "https://localhost:8443",
      VERSION: "6.2.2.6",
      IVERSION: "6226",
      CVERSION: "3.0.9.3",
      HTTPS_STATUS: 2,
      ...
      Printers: {
        ...
        "list": [{
          ...
          "name": "NPI0EF51C (HP LaserJet Pro MFP M226dw)",
          "DriverName": "TP Output Gateway",
          "PortName": "TPVM:",
          "Orientation": "1",
          "PaperSize": "9",
      ...
      OpenWebSocket: function() {
        ...
        try {
          if (!this.webskt || this.webskt.readyState == 3) {
            ...
            this.webskt = new WebSocket('wss://localhost:8443/c_webskt/');
